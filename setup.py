...
setup(
    ...
    author_email="ataozsooy@gmail.com",
    description="Comprehensive Variant Analysis & Annotation Suite",
    long_description=read_readme(),
    long_description_content_type="text/markdown",
    url="https://github.com/ataozsooy/varannote",
    ...
    project_urls={
        "Bug Reports": "https://github.com/ataozsooy/varannote/issues",
        "Source": "https://github.com/ataozsooy/varannote",
